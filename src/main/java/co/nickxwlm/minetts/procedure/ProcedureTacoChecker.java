...
import co.nickxwlm.minetts.item.ItemCompactDisk;
...
public class ProcedureTacoChecker extends ElementsMinettsMod.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		}.getItemStack((int) (0))).getItem() == new ItemStack(ItemGimmetacos.block, (int) (1)).getItem())) {
			if (entity instanceof EntityPlayerMP) {
				Container _current = ((EntityPlayerMP) entity).openContainer;
				if (_current instanceof Supplier) {
					Object invobj = ((Supplier) _current).get();
					if (invobj instanceof Map) {
						ItemStack _setstack = new ItemStack(ItemCompactDisk.block, (int) (1));
