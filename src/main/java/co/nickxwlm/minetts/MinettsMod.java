 ...
 *
 *    Keep the ElementsMinettsMod object in this class and all calls to this object
...
public class MinettsMod {
	...
	public static final String VERSION = "0.1.00a";
	...
	@Mod.Instance(MODID)
	public static MinettsMod instance;
	public ElementsMinettsMod elements = new ElementsMinettsMod();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsMinettsMod.GuiHandler());
