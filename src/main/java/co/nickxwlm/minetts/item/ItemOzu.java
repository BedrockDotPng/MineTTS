...
public class ItemOzu extends ElementsMinettsMod.ModElement {
	@GameRegistry.ObjectHolder("minetts:ozu")
	public static final Item block = null;
	public ItemOzu(ElementsMinettsMod instance) {
		super(instance, 45);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("minetts:ozu", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("ozu");
			setRegistryName("ozu");
