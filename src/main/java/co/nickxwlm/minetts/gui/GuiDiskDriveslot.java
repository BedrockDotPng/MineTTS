...
package co.nickxwlm.minetts.gui;
...
public class GuiDiskDriveslot extends ElementsMinettsMod.ModElement {
	public static int GUIID = 3;
	public static HashMap guistate = new HashMap();
	public GuiDiskDriveslot(ElementsMinettsMod instance) {
		super(instance, 22);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				MinettsMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("minetts:textures/disk_driveslot.png");
		@Override
		...
		protected void actionPerformed(GuiButton button) {
			MinettsMod.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
