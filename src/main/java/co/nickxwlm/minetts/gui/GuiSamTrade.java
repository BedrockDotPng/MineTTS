...
public class GuiSamTrade extends ElementsMinettsMod.ModElement {
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 79, 10) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 79, 50) {
				@Override
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("v", 85, 32, -12829636);
		}
